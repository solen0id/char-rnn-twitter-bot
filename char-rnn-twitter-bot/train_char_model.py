...
from keras.layers import LSTM, Activation, Dense, Dropout, Embedding, TimeDistributed
...
char_to_idx = {
    char: idx for idx, char in enumerate(sorted(set(text)))
}  # string to set splits string into chars
